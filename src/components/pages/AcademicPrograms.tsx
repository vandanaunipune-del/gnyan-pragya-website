      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Program Categories */}
            <Card className="p-8 border-t-4 border-blue-600 hover:shadow-xl transition-shadow">
            ...
            <Card className="p-8 border-t-4 border-teal-600 hover:shadow-xl transition-shadow">
            ...
            <Card className="p-8 border-t-4 border-blue-500 hover:shadow-xl transition-shadow">
            ...
            <Card className="p-8 border-t-4 border-teal-500 hover:shadow-xl transition-shadow">
